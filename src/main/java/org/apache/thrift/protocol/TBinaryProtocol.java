...
public class TBinaryProtocol extends TProtocol {
     ...
     */
    /**
     * 从TTransport中读取可变长度字段(如String或binary)的最大字节数
     * 默认值-1,代表不限制.
     */
    ...
    public void writeMessageBegin(TMessage message) throws TException {
        // 如果是严格写模式
        if (strictWrite_) {
            // 高位2字节置为0x8001,这一步相当于把协议版本信息带入消息类型
